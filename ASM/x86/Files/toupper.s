# PURPOSE: 	This program conerts an input file 
...
#			   file
	...
	.section .data	# For initializing variables and data
...
# the "Counting Like a Computer" section
# of "Programming from the Ground Up" by
# Jonathan Bartlett - where this program
# is based from.
	.equ 	O_RDONLY, 0
...
# standard file descriptors
	...
	.section .bss	# For reserving space for the buffer without initializing it.
...
#	   reasons.
	.equ 	BUFFER_SIZE, 	256
	.lcomm 	BUFFER_DATA,	BUFFER_SIZE	# Creates a 500-byte storage location that can be used as a buffer

.section .text	# For making text for the program to read.
