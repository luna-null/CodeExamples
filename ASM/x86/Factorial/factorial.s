...
factorial:
	pushl %ebp	# sttandard function stuff -
	...
	movl 8(%ebp), %eax	# This moves the 
				# first arg to %eax 
			# 4(%ebp) holds the return
			# address, and 8(%ebp) holds
			# the first parameter
	cmpl $1, %eax	# If the number 1, that is 
