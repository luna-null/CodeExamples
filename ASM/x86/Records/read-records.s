...
# Even though it's a constant, we are saving
# the output file descriptor in a local
# variable so that if we later decide that it
# isn't always going to be STDOUT, we can
# change it easily.
